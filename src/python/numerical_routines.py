...
def compute_double_pendulum_step_euler(m1, m2, g, length1, length2, w1, w2, initialAngle1, initialAngle2, timestep):
...
def compute_double_pendulum_step_rk4(m1, m2, g, length1, length2, w1, w2, initialAngle1, initialAngle2, timestep):

    point1K1, point2K1, point1AngleK1, point2AngleK1 = compute_k_step(m1, m2, g, length1, length2, w1, w2, initialAngle1, initialAngle2, 0, 0, 0, 0, timestep/2)
    point1K2, point2K2, point1AngleK2, point2AngleK2 = compute_k_step(m1, m2, g, length1, length2, w1, w2, initialAngle1, initialAngle2, point1K1, point2K1, point1AngleK1, point2AngleK1, timestep/2)
    point1K3, point2K3, point1AngleK3, point2AngleK3 = compute_k_step(m1, m2, g, length1, length2, w1, w2, initialAngle1, initialAngle2, point1K2, point2K2, point1AngleK2, point2AngleK2, timestep/2)
    point1K4, point2K4, point1AngleK4, point2AngleK4 = compute_k_step(m1, m2, g, length1, length2, w1, w2, initialAngle1, initialAngle2, point1K3, point2K3, point1AngleK3, point2AngleK3, timestep)
...
def compute_k_step(m1, m2, g, length1, length2, w1, w2, initialAngle1, initialAngle2, previousPoint1K, previousPoint2K, previousPoint1AngleK, previousPoint2AngleK, timestep):
    ...
    point1K = compute_angular_velocity_derivative_point1(m1, m2, g, length1, length2, newAngularVelocity1, newAngularVelocity2, newAngle1, newAngle2)
    point2K = compute_angular_velocity_derivative_point2(m1, m2, g, length1, length2, newAngularVelocity1, newAngularVelocity2, newAngle1, newAngle2)
...
def compute_angular_velocity_derivative_point1(m1, m2, g, length1, length2, w1, w2, angle1, angle2):
    u = 1 + m1/m2
    delta = angle1 - angle2
    return (g*(sin(angle2)*cos(delta) - u*sin(angle1)) - (length2*w2**2 + length1*w1**2*cos(delta))*sin(delta)) / (length1*(u - cos(delta)**2))


def compute_angular_velocity_derivative_point2(m1, m2, g, length1, length2, w1, w2, angle1, angle2):
    u = 1 + m1/m2
    delta = angle1 - angle2
